...
docker build -t lab9_webserver $SCRIPT_PATH/images/webserver
docker build -t lab9_dnsserver $SCRIPT_PATH/images/dnsserver
docker build -t lab9_pclient1 $SCRIPT_PATH/images/pclient1
docker build -t lab9_pclient2 $SCRIPT_PATH/images/pclient2
docker build -t lab9_router0 $SCRIPT_PATH/images/router0
docker build -t lab9_router1 $SCRIPT_PATH/images/router1
docker build -t lab9_router2 $SCRIPT_PATH/images/router2
docker build -t lab9_router3 $SCRIPT_PATH/images/router3
